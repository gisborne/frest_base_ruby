(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.frest = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/**
...
},{"./display_options.js":1,"./function_presenter.js":3,"node-uuid":5}],3:[function(require,module,exports){
/**
...
},{"rc-dialog":7,"react":163}],4:[function(require,module,exports){
'use strict';
...
},{"./lib/Dialog":8}],8:[function(require,module,exports){
/** @jsx React.DOM */
...
var ____Class0=React.Component;for(var ____Class0____Key in ____Class0){if(____Class0.hasOwnProperty(____Class0____Key)){Dialog[____Class0____Key]=____Class0[____Class0____Key];}}var ____SuperProtoOf____Class0=____Class0===null?null:____Class0.prototype;Dialog.prototype=Object.create(____SuperProtoOf____Class0);Dialog.prototype.constructor=Dialog;Dialog.__superConstructor__=____Class0;
  Object.defineProperty(Dialog.prototype,"prefixClsFn",{writable:true,configurable:true,value:function() {"use strict";
  ...
  function Dialog(props) {"use strict";
  ...
  Object.defineProperty(Dialog.prototype,"componentWillReceiveProps",{writable:true,configurable:true,value:function(props) {"use strict";
  ...
  Object.defineProperty(Dialog.prototype,"show",{writable:true,configurable:true,value:function() {"use strict";
    var self = this;
  ...
  Object.defineProperty(Dialog.prototype,"close",{writable:true,configurable:true,value:function() {"use strict";
    if (this.state.visible) {
      var props = this.props;
      this.setState({
        visible: false
  ...
  Object.defineProperty(Dialog.prototype,"requestClose",{writable:true,configurable:true,value:function() {"use strict";
    if (this.props.onBeforeClose(this) !== false) {
      this.close();
    }
  }});

  Object.defineProperty(Dialog.prototype,"render",{writable:true,configurable:true,value:function() {"use strict";
    var self = this;
    var props = this.props;
    ...
    return (
      React.createElement("div", {className: className.join(' ')}, 
        React.createElement("div", React.__spread({},  maskProps, {className: prefixClsFn('mask')})), 
        React.createElement("div", {className: [prefixClsFn(''), props.className].join(' '), tabIndex: "0", role: "dialog", ref: "dialog", style: props.style}, 
          React.createElement("div", {className: prefixClsFn('content')}, 
            ...
            closable ?
              (React.createElement("a", {tabIndex: "0", onClick: this.requestClose, className: [prefixClsFn('close')].join('')}, 
  ...
  Object.defineProperty(Dialog.prototype,"componentDidMount",{writable:true,configurable:true,value:function() {"use strict";
    if (this.state.visible) {
